      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-slate-50/80 hover:bg-slate-50/80 border-b border-slate-200">
            ...
            <TableHead className="w-[50px] py-3.5 pr-6" />
          </TableRow>
        </TableHeader>
        <TableBody>
          {accounts.map((row: any) => (
            <TableRow key={row.id} className="hover:bg-slate-50/50">
              ...
              <TableCell className="py-3.5">
                <Badge
                  variant="outline"
                  className="rounded-full border-emerald-300 bg-emerald-50 px-3 py-1 text-xs font-medium text-emerald-700 hover:bg-emerald-50"
                >
                  {row.status}
                </Badge>
              </TableCell>
              ...
              <TableCell className="py-3.5 text-sm text-slate-500">
                <div className="flex items-center gap-1.5">
                  <RiShieldCheckFill className="h-4 w-4 text-slate-500 shrink-0" />
                  <span>{row.authMessage}</span>
                </div>
              </TableCell>
